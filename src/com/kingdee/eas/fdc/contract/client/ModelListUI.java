 ...
 * output class name
 */
public class ModelListUI extends AbstractModelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ModelListUI.class);
    
    /**
     * output class constructor
     */
    public ModelListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.fdc.contract.client.ModelTreeEditUI.class.getName();
    }
