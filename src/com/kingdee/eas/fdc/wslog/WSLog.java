...
import com.kingdee.eas.fdc.wslog.*;
import com.kingdee.bos.metadata.entity.SelectorItemCollection;
import com.kingdee.bos.metadata.entity.SorterItemCollection;

public class WSLog extends AbstractBizCtrl implements IWSLog
{
    public WSLog()
    {
        super();
        registerInterface(IWSLog.class, this);
    }
    public WSLog(Context ctx)
    {
        super(ctx);
        registerInterface(IWSLog.class, this);
    }
    ...
    private Controller getController() throws BOSException
    {
        return (Controller)getBizController();
    }
    /**
