...
public class SaleAreaData extends CoreBase implements ISaleAreaData
{
    public SaleAreaData()
    {
        super();
        registerInterface(ISaleAreaData.class, this);
    }
    public SaleAreaData(Context ctx)
    {
        super(ctx);
        registerInterface(ISaleAreaData.class, this);
    }
    ...
    private SaleAreaDataController getController() throws BOSException
    {
        return (SaleAreaDataController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSaleAreaDataInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleAreaDataInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleAreaDataInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleAreaDataCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleAreaDataCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleAreaDataCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
