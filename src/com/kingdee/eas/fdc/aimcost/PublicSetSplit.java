...
public class PublicSetSplit extends CoreBase implements IPublicSetSplit
{
    public PublicSetSplit()
    {
        super();
        registerInterface(IPublicSetSplit.class, this);
    }
    public PublicSetSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IPublicSetSplit.class, this);
    }
    ...
    private PublicSetSplitController getController() throws BOSException
    {
        return (PublicSetSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPublicSetSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
