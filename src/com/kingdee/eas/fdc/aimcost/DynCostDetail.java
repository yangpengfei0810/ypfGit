...
public class DynCostDetail extends FDCBill implements IDynCostDetail
{
    public DynCostDetail()
    {
        super();
        registerInterface(IDynCostDetail.class, this);
    }
    public DynCostDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IDynCostDetail.class, this);
    }
    ...
    private DynCostDetailController getController() throws BOSException
    {
        return (DynCostDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDynCostDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
