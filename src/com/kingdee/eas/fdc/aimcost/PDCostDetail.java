...
public class PDCostDetail extends CoreBillBase implements IPDCostDetail
{
    public PDCostDetail()
    {
        super();
        registerInterface(IPDCostDetail.class, this);
    }
    public PDCostDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IPDCostDetail.class, this);
    }
    ...
    private PDCostDetailController getController() throws BOSException
    {
        return (PDCostDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPDCostDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
