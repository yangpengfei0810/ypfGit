...
public class MeasureCollectData extends CoreBase implements IMeasureCollectData
{
    public MeasureCollectData()
    {
        super();
        registerInterface(IMeasureCollectData.class, this);
    }
    public MeasureCollectData(Context ctx)
    {
        super(ctx);
        registerInterface(IMeasureCollectData.class, this);
    }
    ...
    private MeasureCollectDataController getController() throws BOSException
    {
        return (MeasureCollectDataController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMeasureCollectDataInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasureCollectDataInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasureCollectDataInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasureCollectDataCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasureCollectDataCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasureCollectDataCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
