...
public class ConOccSplitList extends CoreBase implements IConOccSplitList
{
    public ConOccSplitList()
    {
        super();
        registerInterface(IConOccSplitList.class, this);
    }
    public ConOccSplitList(Context ctx)
    {
        super(ctx);
        registerInterface(IConOccSplitList.class, this);
    }
    ...
    private ConOccSplitListController getController() throws BOSException
    {
        return (ConOccSplitListController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getConOccSplitListInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
