...
public class PDCostDetailEntry extends CoreBase implements IPDCostDetailEntry
{
    public PDCostDetailEntry()
    {
        super();
        registerInterface(IPDCostDetailEntry.class, this);
    }
    public PDCostDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPDCostDetailEntry.class, this);
    }
    ...
    private PDCostDetailEntryController getController() throws BOSException
    {
        return (PDCostDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPDCostDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPDCostDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
