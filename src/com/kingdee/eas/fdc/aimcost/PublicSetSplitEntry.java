...
public class PublicSetSplitEntry extends CoreBase implements IPublicSetSplitEntry
{
    public PublicSetSplitEntry()
    {
        super();
        registerInterface(IPublicSetSplitEntry.class, this);
    }
    public PublicSetSplitEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPublicSetSplitEntry.class, this);
    }
    ...
    private PublicSetSplitEntryController getController() throws BOSException
    {
        return (PublicSetSplitEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPublicSetSplitEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicSetSplitEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
