...
public class PublicToSplit extends CoreBase implements IPublicToSplit
{
    public PublicToSplit()
    {
        super();
        registerInterface(IPublicToSplit.class, this);
    }
    public PublicToSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IPublicToSplit.class, this);
    }
    ...
    private PublicToSplitController getController() throws BOSException
    {
        return (PublicToSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPublicToSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicToSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicToSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicToSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicToSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPublicToSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
