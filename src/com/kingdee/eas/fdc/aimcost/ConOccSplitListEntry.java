...
public class ConOccSplitListEntry extends CoreBase implements IConOccSplitListEntry
{
    public ConOccSplitListEntry()
    {
        super();
        registerInterface(IConOccSplitListEntry.class, this);
    }
    public ConOccSplitListEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IConOccSplitListEntry.class, this);
    }
    ...
    private ConOccSplitListEntryController getController() throws BOSException
    {
        return (ConOccSplitListEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getConOccSplitListEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConOccSplitListEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
