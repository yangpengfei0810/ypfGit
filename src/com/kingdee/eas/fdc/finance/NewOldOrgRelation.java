...
public class NewOldOrgRelation extends CoreBase implements INewOldOrgRelation
{
    public NewOldOrgRelation()
    {
        super();
        registerInterface(INewOldOrgRelation.class, this);
    }
    public NewOldOrgRelation(Context ctx)
    {
        super(ctx);
        registerInterface(INewOldOrgRelation.class, this);
    }
    ...
    private NewOldOrgRelationController getController() throws BOSException
    {
        return (NewOldOrgRelationController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getNewOldOrgRelationInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldOrgRelationInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldOrgRelationInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldOrgRelationCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldOrgRelationCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldOrgRelationCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
