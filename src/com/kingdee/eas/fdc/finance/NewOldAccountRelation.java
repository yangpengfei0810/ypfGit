...
public class NewOldAccountRelation extends CoreBase implements INewOldAccountRelation
{
    public NewOldAccountRelation()
    {
        super();
        registerInterface(INewOldAccountRelation.class, this);
    }
    public NewOldAccountRelation(Context ctx)
    {
        super(ctx);
        registerInterface(INewOldAccountRelation.class, this);
    }
    ...
    private NewOldAccountRelationController getController() throws BOSException
    {
        return (NewOldAccountRelationController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getNewOldAccountRelationInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldAccountRelationInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldAccountRelationInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldAccountRelationCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldAccountRelationCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNewOldAccountRelationCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *保存自定义-User defined method
     *@param accountRelationColl 科目映射关系集合
     *@param company 财务组织id
     */
    ...
    {
        try {
            getController().submitAll(getContext(), accountRelationColl, company);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
